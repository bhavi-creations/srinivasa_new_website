                                    ...
                                    <form style='color:black;' id="addblogform" action="addBlog.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="filter-section mb-3">
                                            ...
                                            <select id="service" name="service" class="form-control" required>
                                                ...
                                                <option value="Periapical Surgery">Periapical Surgery</option>
                                                <option value="Gum Surgery">Laser Gum Surgery </option>
                                                ...
                                                <option value="Major Head & Neck Surgeries">Major Head & Neck Surgeries</option>
                    ...
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <div class="footer-widget__copyright">
                                <p class="mini_text" style="color:black"> ©2025 Appledental . All Rights Reserved. Designed & Developed by <a href="https://bhavicreations.com/" target="_blank" style="text-decoration: none;color:black">Bhavi Creations</a></p>
                            </div>
                        </div>
                    </div>
                </footer>
