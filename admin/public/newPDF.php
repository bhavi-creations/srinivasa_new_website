                        ...
                        <div class="col-xl-11 ">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-success">UPLOAD PDF</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form style='color:black;' id="uploadpdfform" action="uploadPDF.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <label for="formFilePDF" class="form-label text-primary">Choose PDF</label>
                                            <input class="form-control" name="pdf" type="file" id="formFilePDF" accept=".pdf" required>
                                        </div>
                                        <div class='row p-3'>
                    ...
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <div class="footer-widget__copyright">
                                <p class="mini_text" style="color:black"> ©2025 Srinivasa dental hospital . All Rights Reserved. Designed & Developed by <a href="https://bhavicreations.com/" target="_blank" style="text-decoration: none;color:black">Bhavi Creations</a></p>
                            </div>
                        </div>
                    </div>
                </footer>
