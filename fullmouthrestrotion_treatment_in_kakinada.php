...
<section class="tooth_extraction_hero fullmouthrestrotion_treatment_hero">
  <div class="container">
    ...
    <h1 class="tooth_extraction_title">FULL MOUTH<br>RESTORATION</h1>
    <h2 class="tooth_extraction_subtitle">
      Rebuild. Restore. Rejuvenate.<br>
      A Complete Transformation<br>
      for a Healthy, Beautiful Smile.
    </h2>

    <p class="tooth_extraction_text">
      Full mouth restoration is a comprehensive, personalized treatment plan to rebuild and restore the function, health, and aesthetics of your entire smile.
    </p>
...
<section class="tooth_extraction_section">
  <div class="container">
    ...
    <div class="tooth_extraction_heading_small">— THE RESTORATION JOURNEY —</div>
    ...
    <div class="row g-3">
      ...
      <div class="col-lg-4">
        <div class="tooth_extraction_faq_card">
          <h5>Is full mouth restoration painful? <i class="bi bi-chevron-down"></i></h5>
          <p>No, we use modern techniques and anesthesia to ensure a comfortable, pain-free experience.</p>
        </div>
      </div>

      <div class="col-lg-4">
        <div class="tooth_extraction_faq_card">
          <h5>How long do the results last? <i class="bi bi-chevron-down"></i></h5>
          <p>With proper care and regular check-ups, results can last many years, even a lifetime.</p>
        </div>
      </div>
    </div>
    ...
    <div class="tooth_extraction_cta">
      <div class="row align-items-center g-3">
        ...
        <div class="col-lg-5">
          <h3>A Complete Transformation. A Better You.</h3>
