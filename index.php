...
<section class="home_section_hero">
  <div class="container">
    <div class="col-lg-6">
...
<div class="container">
  <div class="home_section_booking">
    <div class="row align-items-center g-3">
      ...
      <div class="col-lg-2"><input class="form-control home_section_input" placeholder="Your Name"></div>
      <div class="col-lg-2"><input class="form-control home_section_input" placeholder="Phone Number"></div>
      <div class="col-lg-2">
        <select class="form-select home_section_input">
          <option>Select Service</option>
          <option>Dental Implants</option>
          <option>Root Canal</option>
        </select>
      </div>
      <div class="col-lg-2"><input type="date" class="form-control home_section_input"></div>
      <div class="col-lg-1">
        <button class="home_section_btn_gold w-100">BOOK</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-3">
        <div class="home_section_about_box">
          ...
          <div class="home_section_about_box_item">
            <div class="home_section_about_box_icon"><i class="bi bi-clock-history"></i></div> 24/7 Support
          </div>
        </div>
      </div>
    </div>
...
<section class="home_section_testimonials">
  <div class="container">
    ...
    <h2 class="home_section_heading">What Our Patients Say</h2>
