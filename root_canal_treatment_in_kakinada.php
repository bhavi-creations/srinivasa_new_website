...
<section class="tooth_extraction_icon_strip">
  <div class="container">
    <div class="tooth_extraction_strip_box">
      <div class="row g-0">
        <div class="col-lg col-md-4 col-6"><div class="tooth_extraction_strip_item"><i class="bi bi-pc-display"></i>Advanced Technology<br><small>Latest rotary instruments for precision</small></div></div>
        <div class="col-lg col-md-4 col-6"><div class="tooth_extraction_strip_item"><i class="bi bi-emoji-smile"></i>Painless Treatment<br><small>Comfortable & virtually pain-free experience</small></div></div>
        <div class="col-lg col-md-4 col-6"><div class="tooth_extraction_strip_item"><i class="bi bi-person-badge"></i>Experienced Endodontists<br><small>Specialized care for best results</small></div></div>
        <div class="col-lg col-md-4 col-6"><div class="tooth_extraction_strip_item"><i class="bi bi-shield-check"></i>Safe & Hygienic<br><small>Sterile environment for your safety</small></div></div>
      </div>
    </div>
  </div>
</section>
...
<section class="tooth_extraction_section">
  <div class="container">
    ...
    <div class="row g-3">
      <div class="col-lg-4"><div class="tooth_extraction_faq_card"><h5>Is root canal treatment painful? <i class="bi bi-chevron-down"></i></h5><p>No. With modern technology and anesthesia, the procedure is virtually pain-free.</p></div></div>
      <div class="col-lg-4"><div class="tooth_extraction_faq_card"><h5>How long does the treatment take? <i class="bi bi-chevron-down"></i></h5><p>Usually 1 to 2 visits depending on the condition of the tooth.</p></div></div>
      <div class="col-lg-4"><div class="tooth_extraction_faq_card"><h5>Will I need a crown after RCT? <i class="bi bi-chevron-down"></i></h5><p>In most cases, yes. A crown protects the tooth and restores full strength.</p></div></div>
    </div>
