...
<section class="tooth_extraction_section">
  <div class="container">
    ...
    <div class="row g-4">
      ...
      <div class="col-lg-6">
        <div class="tooth_extraction_card d-block d-md-none">
        ...
        <div class="tooth_extraction_card  d-none d-md-block">
          <h3>TREATMENTS MAY INCLUDE</h3>
    ...
    <div class="row g-3">
      <div class="col-lg-4">
        <div class="tooth_extraction_faq_card">
          <h5>How long does a smile makeover take? <i class="bi bi-chevron-down"></i></h5>
          <p>The duration depends on your treatment plan. It can take a few days to several weeks.</p>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="tooth_extraction_faq_card">
          <h5>Is a smile makeover painful? <i class="bi bi-chevron-down"></i></h5>
          <p>No, we use advanced techniques and anesthesia to ensure a comfortable, pain-free experience.</p>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="tooth_extraction_faq_card">
          <h5>Will the results look natural? <i class="bi bi-chevron-down"></i></h5>
          <p>Yes! Our goal is to enhance your natural beauty and create a smile that looks just right for you.</p>
        </div>
      </div>
    </div>
    ...
    <div class="tooth_extraction_cta">
      <div class="row align-items-center g-3">
        ...
        <div class="col-lg-5">
          <h3>Your Dream Smile. Our Expertise.</h3>
